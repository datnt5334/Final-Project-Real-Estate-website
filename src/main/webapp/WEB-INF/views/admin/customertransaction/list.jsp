...
<c:url var="formUrl" value="/api/customer-transactionType"/>
<html>
<head>
    <title>Danh sách loại giao dịch với khách hàng</title>
</head>
<body>
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Quản lý loại giao dịch với khách hàng</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">Trang chủ</a></li>
            <li class="breadcrumb-item">Quản lý loại giao dịch</li>
            <li class="breadcrumb-item active" aria-current="page">Danh sách loại giao dịch với khách hàng</li>
        </ol>
    </div>
        ...
        <div class="col-lg-5 mb-4">
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Danh sách loại giao dịch với khách hàng</h6>
                    <span>
...
<script type="text/javascript">
    ...
    function addTransactionType(data) {
        $.ajax({
            ...
            success: function () {
                window.location.href = "<c:url value='/admin/customer-transaction/list?message=insert_success'/>";
            },
            error: function () {
                window.location.href = "<c:url value='/admin/customer-transaction/list?message=error_system'/>";
            }
        });
    }
    ...
    function deleteTransactionType(data) {
        $.ajax({
            ...
            success: function (res) {
                window.location.href = "<c:url value='/admin/customer-transaction/list?message=delete_success'/>";
            },
            error: function (res) {
                window.location.href = "<c:url value='/admin/customer-transaciton/list?message=error_system'/>";
            }
        });
    }
</script>
