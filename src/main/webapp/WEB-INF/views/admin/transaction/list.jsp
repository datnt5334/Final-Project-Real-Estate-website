...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Quản lý loại giao dịch</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">Trang chủ</a></li>
            <li class="breadcrumb-item">Quản lý loại giao dịch</li>
            <li class="breadcrumb-item active" aria-current="page">Danh sách loại giao dịch</li>
        </ol>
    </div>
    <div class="row">
...
<script type="text/javascript">
    ...
    function addTransactionType(data) {
        $.ajax({
            ...
            success: function () {
                window.location.href = "<c:url value='/admin/transaction/list?message=insert_success'/>";
            },
            error: function () {
                window.location.href = "<c:url value='/admin/transaction/list?message=error_system'/>";
            }
        });
    }
    ...
    function deleteTransactionType(data) {
        $.ajax({
            ...
            success: function (res) {
                window.location.href = "<c:url value='/admin/transaction/list?message=delete_success'/>";
            },
            error: function (res) {
                window.location.href = "<c:url value='/admin/transaciton/list?message=error_system'/>";
            }
        });
    }
</script>
