...
import vn.edu.hust.samiestate.security.CustomSuccessHandler;
import vn.edu.hust.samiestate.service.impl.CustomUserDetailService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
                ...
                .and().exceptionHandling().accessDeniedPage("/login?accessDenied").and()
